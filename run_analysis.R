library(data.table)
## unzip file  from the working directory
...
##Part1 - merge train and test data in one dataset 
...
## First 15 rows and 5 columns in Tidy dataset:
head(TidyData[order(SubjectID)][,c(1:4), with = FALSE],15) 